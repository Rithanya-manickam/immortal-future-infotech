...
const TILES = [
  { label: "Neural Ops Center", grad: "linear-gradient(135deg, oklch(0.35 0.15 260), oklch(0.7 0.22 220))", h: "md:row-span-2" },
  { label: "Autonomous Data Grid", grad: "linear-gradient(135deg, oklch(0.4 0.2 320), oklch(0.75 0.24 340))" },
  { label: "Cyber Perimeter", grad: "linear-gradient(135deg, oklch(0.35 0.15 20), oklch(0.7 0.24 40))" },
  { label: "Cloud Fabric", grad: "linear-gradient(135deg, oklch(0.3 0.12 200), oklch(0.72 0.18 180))", h: "md:row-span-2" },
  { label: "Finacle Suite", grad: "linear-gradient(135deg, oklch(0.35 0.1 90), oklch(0.8 0.16 90))" },
  { label: "Enterprise HQ", grad: "linear-gradient(135deg, oklch(0.28 0.06 275), oklch(0.6 0.15 275))" },
];
