    ...
    >
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, oklch(0.98 0.02 190 / 0.98) 0%, oklch(0.93 0.04 190 / 0.96) 55%, oklch(0.88 0.06 190 / 0.98) 100%)",
          }}
        />
        <div
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3">
              <img
                ...
                style={{ filter: "drop-shadow(0 0 12px oklch(0.62 0.14 170 / .45))" }}
              />
              <div className="leading-tight">
                ...
                <div className="text-[10px] uppercase tracking-[0.35em] text-foreground/40">
                  Technology Lives Forever
                </div>
              </div>
            </div>
            <p className="mt-5 max-w-md text-sm text-foreground/55">
              AI-first technology company building intelligent solutions for Indian banking,
              healthcare and enterprise IT.
            </p>
            <div className="mt-6 flex flex-col gap-2 text-xs text-foreground/60">
              <div className="flex items-center gap-2">
                <MapPin className="h-3.5 w-3.5" /> Tiruchirapalli, Tamil Nadu 621211, India
              </div>
              <a
                href="mailto:info@ifitipl.com"
                className="flex items-center gap-2 hover:text-foreground"
              >
                <Mail className="h-3.5 w-3.5" /> info@ifitipl.com
              </a>
              <a href="tel:+919159855985" className="flex items-center gap-2 hover:text-foreground">
                <Phone className="h-3.5 w-3.5" /> +91 91598 55985
              </a>
            </div>
          </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border/10 pt-6 md:flex-row">
          ...
          <div className="flex items-center gap-3">
            {[
              {
                Icon: Linkedin,
                href: "https://www.linkedin.com/company/immortal-future-info-tech",
                label: "LinkedIn",
              },
